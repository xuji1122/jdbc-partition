...
import org.the.force.thirdparty.druid.sql.dialect.mysql.ast.clause.ConditionValue;
import org.the.force.thirdparty.druid.sql.dialect.mysql.ast.clause.ConditionValue.ConditionType;
...
import org.the.force.thirdparty.druid.sql.visitor.ParameterizedOutputVisitorUtils;
...
public class MySqlOutputVisitor extends SQLASTOutputVisitor implements MySqlASTVisitor {
    ...
    public boolean visit(MySqlCreateTableStatement x) {
        ...
        if (SQLCreateTableStatement.Type.GLOBAL_TEMPORARY.equals(x.getType())) {
            print0(ucase ? "TEMPORARY TABLE " : "temporary executor ");
        } else {
    ...
    public boolean visit(MySqlInsertStatement x) {
        ...
        if (!x.getValuesList().isEmpty()) {
            println();
            //modified by xuji @2017-07-22
            printValuesList(getValuesList(x));
        }
    ...
    public boolean visit(MySqlLoadDataInFileStatement x) {
        ...
        print0(ucase ? " INTO TABLE " : " into executor ");
    ...
    public boolean visit(MySqlShowCreateTableStatement x) {
        print0(ucase ? "SHOW CREATE TABLE " : "show create executor ");
        x.getName().accept(this);
        return false;
    }
    ...
    public boolean visit(MySqlShowTableStatusStatement x) {
        print0(ucase ? "SHOW TABLE STATUS" : "show executor status");
        if (x.getDatabase() != null) {
            print0(ucase ? " FROM " : " from ");
            x.getDatabase().accept(this);
        }
    ...
    public boolean visit(SQLAlterTableStatement x) {
        if (x.isIgnore()) {
            print0(ucase ? "ALTER IGNORE TABLE " : "alter ignore executor ");
        } else {
    ...
    public boolean visit(MySqlRenameTableStatement x) {
        print0(ucase ? "RENAME TABLE " : "rename executor ");
