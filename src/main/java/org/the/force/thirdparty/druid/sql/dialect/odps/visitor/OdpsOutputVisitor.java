 ...
 */
package org.the.force.thirdparty.druid.sql.dialect.odps.visitor;
...
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsGrantStmt;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsListStmt;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsReadStatement;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsSelectQueryBlock;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsShowStatisticStmt;
...
import org.the.force.thirdparty.druid.sql.ast.statement.SQLJoinTableSource.JoinType;
...
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsAddStatisticStatement;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsAnalyzeTableStatement;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsCreateTableStatement;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsInsert;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsInsertStatement;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsLateralViewTableSource;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsRemoveStatisticStatement;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsSetLabelStatement;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsShowGrantsStmt;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsShowPartitionsStmt;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsStatisticClause;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsUDTFSQLSelectItem;
import org.the.force.thirdparty.druid.sql.dialect.odps.ast.OdpsValuesTableSource;
...
public class OdpsOutputVisitor extends SQLASTOutputVisitor implements OdpsASTVisitor {
    ...
    public boolean visit(OdpsCreateTableStatement x) {
        if (x.isIfNotExiists()) {
            print0(ucase ? "CREATE TABLE IF NOT EXISTS " : "create executor if not exists ");
        } else {
            print0(ucase ? "CREATE TABLE " : "create executor ");
        }
    ...
    public boolean visit(OdpsInsert x) {
        ...
        if (x.isOverwrite()) {
            print0(ucase ? "INSERT OVERWRITE TABLE " : "insert overwrite executor ");
        } else {
            print0(ucase ? "INSERT INTO TABLE " : "insert into executor ");
        }
...
//    }
    ...
    public boolean visit(OdpsAnalyzeTableStatement x) {
        print0(ucase ? "ANALYZE TABLE " : "analyze executor ");
        x.getTable().accept(this);
