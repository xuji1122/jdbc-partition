...
import org.the.force.thirdparty.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import org.the.force.thirdparty.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
...
//    }
    ...
    public boolean visit(OracleLockTableStatement x) {
        print0(ucase ? "LOCK TABLE " : "lock executor ");
