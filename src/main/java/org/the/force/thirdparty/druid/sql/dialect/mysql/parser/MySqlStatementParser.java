...
import org.the.force.thirdparty.druid.sql.dialect.mysql.ast.clause.MySqlHandlerType;
...
import org.the.force.thirdparty.druid.sql.ast.statement.SQLInsertStatement.ValuesClause;
...
import org.the.force.thirdparty.druid.sql.dialect.mysql.ast.statement.MySqlLockTableStatement.LockType;
...
//            if (lexer.token() == JsonToken.DEFAULT) {
//                lexer.nextToken();
