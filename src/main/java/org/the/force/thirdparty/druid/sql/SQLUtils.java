 ...
 */
package org.the.force.thirdparty.druid.sql;

import org.the.force.thirdparty.druid.sql.ast.statement.SQLSelectQueryBlock;
import org.the.force.thirdparty.druid.sql.ast.SQLExpr;
import org.the.force.thirdparty.druid.sql.ast.SQLObject;
import org.the.force.thirdparty.druid.sql.ast.SQLReplaceable;
...
import org.the.force.thirdparty.druid.sql.ast.expr.SQLUnaryOperator;
...
import org.the.force.thirdparty.druid.sql.dialect.odps.visitor.OdpsOutputVisitor;
import org.the.force.thirdparty.druid.sql.dialect.oracle.visitor.OracleOutputVisitor;
import org.the.force.thirdparty.druid.sql.dialect.oracle.visitor.OracleToMySqlOutputVisitor;
import org.the.force.thirdparty.druid.sql.dialect.postgresql.visitor.PGOutputVisitor;
import org.the.force.thirdparty.druid.sql.dialect.sqlserver.visitor.SQLServerOutputVisitor;
...
import org.the.force.thirdparty.druid.sql.parser.SQLParserUtils;
...
import org.the.force.thirdparty.druid.util.Utils;
...
public class SQLUtils {
     ...
     * @param columnName
     * @param tableAlias
     * @param pattern if pattern is null,it will be set {%Y-%m-%d %H:%i:%s} as mysql default evaluator and set {yyyy-mm-dd
     * hh24:mi:ss} as oracle default evaluator
     * @param dbType {@link JdbcConstants} if dbType is null ,it will be set the mysql as a default evaluator
     */
