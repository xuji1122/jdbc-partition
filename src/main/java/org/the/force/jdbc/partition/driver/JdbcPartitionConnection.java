...
public class JdbcPartitionConnection extends AbstractConnection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        if (sqlExecutor instanceof BatchAbleSqlExecution) {
            return new BathAbleSqlEngine(this, (BatchAbleSqlExecution) sqlExecutor);
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        if (sqlExecutor instanceof BatchAbleSqlExecution) {
            return new BathAbleSqlEngine(this, (BatchAbleSqlExecution) sqlExecutor, b);
        } else {
            if (b) {
                //TODO check null
            } else {
