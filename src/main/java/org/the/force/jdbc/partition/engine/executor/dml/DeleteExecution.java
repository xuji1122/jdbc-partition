 ...
 */
public class DeleteExecution implements BatchAbleSqlExecution {

    private static Log logger = LogFactory.getLog(DeleteExecution.class);
    ...
    public DeleteExecution(LogicDbConfig logicDbConfig, SQLDeleteStatement sqlStatement) throws Exception {
    ...
    public String toString() {
        return "DeleteExecution{" + "updateDelParser=" + updateDelParser + '}';
    }
