...
public class MySqlPartitionSqlOutput extends MySqlOutputVisitor implements PartitionSqlASTVisitor {
    ...
    public MySqlPartitionSqlOutput(Appendable appender, LogicDbConfig logicDbConfig, SqlLineExecRequest sqlLineExecRequest, SqlTablePartition sqlTablePartition) {
    ...
    public boolean visit(SQLVariantRefExpr x) {
        parametric = true;
        SqlParameter sqlParameter = sqlLineExecRequest.getSqlLineParameter().getSqlParameter(x.getIndex());
    ...
    public boolean visit(SQLLimit x) {
        ...
        if (x.getOffset() != null) {
            try {
                Object v = sqlExprEvaluatorFactory.matchSqlExprEvaluator(x.getOffset()).eval(sqlLineExecRequest, null);
        ...
        try {
            Object v = sqlExprEvaluatorFactory.matchSqlExprEvaluator(x.getRowCount()).eval(sqlLineExecRequest, null);
