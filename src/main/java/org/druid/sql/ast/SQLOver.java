...
public class SQLOver extends SQLObjectImpl {
    ...
    public boolean equals(Object o) {
        ...
        org.druid.sql.ast.SQLOver sqlOver = (org.druid.sql.ast.SQLOver) o;
    ...
    public void cloneTo(org.druid.sql.ast.SQLOver x) {
    ...
    public org.druid.sql.ast.SQLOver clone() {
        org.druid.sql.ast.SQLOver x = new org.druid.sql.ast.SQLOver();
        cloneTo(x);
        return x;
    }
