...
public abstract class SQLPartitionBy extends SQLObjectImpl {
    ...
    protected List<org.druid.sql.ast.SQLPartition> partitions = new ArrayList<org.druid.sql.ast.SQLPartition>();

    protected List<SQLName>      storeIn    = new ArrayList<SQLName>();

    public List<org.druid.sql.ast.SQLPartition> getPartitions() {
        return partitions;
    }
