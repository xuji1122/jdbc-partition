...
public class SQLParameter extends SQLObjectImpl {
    ...
    private org.druid.sql.ast.SQLDataType dataType;
    ...
    private final List<org.druid.sql.ast.SQLParameter> cursorParameters = new ArrayList<org.druid.sql.ast.SQLParameter>();
    ...
    public org.druid.sql.ast.SQLDataType getDataType() {
        return dataType;
    }
    ...
    public List<org.druid.sql.ast.SQLParameter> getCursorParameters() {
