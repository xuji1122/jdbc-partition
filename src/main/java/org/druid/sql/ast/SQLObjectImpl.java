...
public abstract class SQLObjectImpl implements SQLObject {
    ...
    private org.druid.sql.ast.SQLObject parent;
    ...
    protected final void acceptChild(SQLASTVisitor visitor, List<? extends SQLObject> children) {
        ...
        for (org.druid.sql.ast.SQLObject child : children) {
    ...
    public org.druid.sql.ast.SQLObject getParent() {
        return parent;
    }

    public void setParent(org.druid.sql.ast.SQLObject parent) {
        this.parent = parent;
    }
