...
public class SQLDropTableStatement extends SQLStatementImpl implements SQLDDLStatement {
    ...
    public SQLDropTableStatement(SQLName name, String dbType){
        this(new org.druid.sql.ast.statement.SQLExprTableSource(name), dbType);
    }
    ...
    public SQLDropTableStatement(org.druid.sql.ast.statement.SQLExprTableSource tableSource){
        this (tableSource, null);
    }

    public SQLDropTableStatement(org.druid.sql.ast.statement.SQLExprTableSource tableSource, String dbType){
        this (dbType);
