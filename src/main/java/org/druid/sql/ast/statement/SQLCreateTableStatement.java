...
import org.druid.util.lang.Consumer;
...
public class SQLCreateTableStatement extends SQLStatementImpl implements SQLDDLStatement {
    ...
    // for postgresql
    private org.druid.sql.ast.statement.SQLExprTableSource inherits;
    ...
    public org.druid.sql.ast.statement.SQLExprTableSource getInherits() {
        return inherits;
    }
