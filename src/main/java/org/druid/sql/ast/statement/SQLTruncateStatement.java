...
public class SQLTruncateStatement extends SQLStatementImpl {
    ...
    protected List<org.druid.sql.ast.statement.SQLExprTableSource> tableSources               = new ArrayList<org.druid.sql.ast.statement.SQLExprTableSource>(2);
    ...
    public void setTableSources(List<org.druid.sql.ast.statement.SQLExprTableSource> tableSources) {
        this.tableSources = tableSources;
    }

    public void addTableSource(SQLName name) {
        org.druid.sql.ast.statement.SQLExprTableSource tableSource = new SQLExprTableSource(name);
