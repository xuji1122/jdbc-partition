...
public class SQLSubqueryTableSource extends SQLTableSourceImpl {
    ...
    public org.druid.sql.ast.statement.SQLSubqueryTableSource clone() {
        org.druid.sql.ast.statement.SQLSubqueryTableSource x = new org.druid.sql.ast.statement.SQLSubqueryTableSource();
