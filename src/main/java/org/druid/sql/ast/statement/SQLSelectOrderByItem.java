...
public class SQLSelectOrderByItem extends SQLObjectImpl implements SQLReplaceable {
    ...
    public boolean equals(Object obj) {
        ...
        org.druid.sql.ast.statement.SQLSelectOrderByItem other = (org.druid.sql.ast.statement.SQLSelectOrderByItem) obj;
        if (collate == null) {
    ...
    public org.druid.sql.ast.statement.SQLSelectOrderByItem clone() {
        org.druid.sql.ast.statement.SQLSelectOrderByItem x = new org.druid.sql.ast.statement.SQLSelectOrderByItem();
        if (expr != null) {
