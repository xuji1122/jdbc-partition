...
import org.druid.sql.repository.SchemaObject;
...
public class SQLExprTableSource extends SQLTableSourceImpl {
    ...
    public boolean equals(Object o) {
        ...
        org.druid.sql.ast.statement.SQLExprTableSource that = (org.druid.sql.ast.statement.SQLExprTableSource) o;
    ...
    public org.druid.sql.ast.statement.SQLExprTableSource clone() {
        org.druid.sql.ast.statement.SQLExprTableSource x = new org.druid.sql.ast.statement.SQLExprTableSource();
        cloneTo(x);
        return x;
    }

    public void cloneTo(org.druid.sql.ast.statement.SQLExprTableSource x) {
        x.alias = alias;
