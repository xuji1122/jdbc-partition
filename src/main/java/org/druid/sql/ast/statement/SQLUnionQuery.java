...
public class SQLUnionQuery extends SQLObjectImpl implements org.druid.sql.ast.statement.SQLSelectQuery {

    private boolean          bracket  = false;

    private org.druid.sql.ast.statement.SQLSelectQuery left;
    private org.druid.sql.ast.statement.SQLSelectQuery right;
    ...
    public org.druid.sql.ast.statement.SQLSelectQuery getLeft() {
        return left;
    }

    public void setLeft(org.druid.sql.ast.statement.SQLSelectQuery left) {
        if (left != null) {
            left.setParent(this);
        }
        this.left = left;
    ...
    public org.druid.sql.ast.statement.SQLSelectQuery getRight() {
        return right;
    }
