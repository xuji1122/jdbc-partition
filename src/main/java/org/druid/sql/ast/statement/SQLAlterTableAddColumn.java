...
public class SQLAlterTableAddColumn extends SQLObjectImpl implements SQLAlterTableItem {
    ...
    private final List<org.druid.sql.ast.statement.SQLColumnDefinition> columns = new ArrayList<org.druid.sql.ast.statement.SQLColumnDefinition>();
    ...
    public List<org.druid.sql.ast.statement.SQLColumnDefinition> getColumns() {
        return columns;
    }
