...
import org.druid.sql.dialect.oracle.ast.OracleSegmentAttributesImpl;
...
public class SQLPartition extends OracleSegmentAttributesImpl implements OracleSegmentAttributes {
    ...
    protected org.druid.sql.ast.SQLPartitionValue values;
    ...
    public org.druid.sql.ast.SQLPartitionValue getValues() {
        return values;
    }
