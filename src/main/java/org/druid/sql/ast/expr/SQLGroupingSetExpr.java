...
public class SQLGroupingSetExpr extends SQLExprImpl {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof org.druid.sql.ast.expr.SQLGroupingSetExpr)) {
            return false;
        }
        org.druid.sql.ast.expr.SQLGroupingSetExpr other = (org.druid.sql.ast.expr.SQLGroupingSetExpr) obj;
        if (parameters == null) {
