...
public class SQLIntegerExpr extends SQLNumericLiteralExpr implements SQLValuableExpr {
    ...
    public boolean equals(Object obj) {
        ...
        org.druid.sql.ast.expr.SQLIntegerExpr other = (org.druid.sql.ast.expr.SQLIntegerExpr) obj;
        if (number == null) {
    ...
    public org.druid.sql.ast.expr.SQLIntegerExpr clone() {
        return new org.druid.sql.ast.expr.SQLIntegerExpr(this.number);
    }
}
