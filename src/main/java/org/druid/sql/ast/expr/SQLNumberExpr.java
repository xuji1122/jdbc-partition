...
public class SQLNumberExpr extends SQLNumericLiteralExpr {
    ...
    public boolean equals(Object obj) {
        ...
        org.druid.sql.ast.expr.SQLNumberExpr other = (org.druid.sql.ast.expr.SQLNumberExpr) obj;
        if (number == null) {
    ...
    public org.druid.sql.ast.expr.SQLNumberExpr clone() {
        return new org.druid.sql.ast.expr.SQLNumberExpr(number);
    }
}
