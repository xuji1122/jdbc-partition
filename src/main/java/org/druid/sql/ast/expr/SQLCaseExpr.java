...
public class SQLCaseExpr extends SQLExprImpl implements SQLReplaceable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        org.druid.sql.ast.expr.SQLCaseExpr other = (org.druid.sql.ast.expr.SQLCaseExpr) obj;
        if (elseExpr == null) {
    ...
    public org.druid.sql.ast.expr.SQLCaseExpr clone() {
        org.druid.sql.ast.expr.SQLCaseExpr x = new org.druid.sql.ast.expr.SQLCaseExpr();
