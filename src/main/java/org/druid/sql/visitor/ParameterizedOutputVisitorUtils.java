...
import org.druid.sql.dialect.phoenix.visitor.PhoenixOutputVisitor;
...
public class ParameterizedOutputVisitorUtils {
    ...
    public static boolean checkParameterize(SQLObject x) {
        if (Boolean.TRUE.equals(x.getAttribute(org.druid.sql.visitor.ParameterizedOutputVisitorUtils.ATTR_PARAMS_SKIP))) {
            return false;
        }
