...
public class SQLParser {
    ...
    protected final org.druid.sql.parser.Lexer lexer;

    protected String      dbType;

    public SQLParser(String sql, String dbType){
        this(new org.druid.sql.parser.Lexer(sql, null, dbType), dbType);
    ...
    public SQLParser(org.druid.sql.parser.Lexer lexer){
        this(lexer, null);
    }

    public SQLParser(org.druid.sql.parser.Lexer lexer, String dbType){
        this.lexer = lexer;
        this.dbType = dbType;
    }
