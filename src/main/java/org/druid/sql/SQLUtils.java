...
import org.druid.sql.dialect.odps.visitor.OdpsOutputVisitor;
import org.druid.sql.dialect.oracle.visitor.OracleOutputVisitor;
import org.druid.sql.dialect.oracle.visitor.OracleToMySqlOutputVisitor;
import org.druid.sql.dialect.postgresql.visitor.PGOutputVisitor;
import org.druid.sql.dialect.sqlserver.visitor.SQLServerOutputVisitor;
import org.druid.sql.parser.Lexer;
import org.druid.sql.parser.ParserException;
import org.druid.sql.parser.SQLExprParser;
import org.druid.sql.parser.SQLParserUtils;
...
import org.druid.support.logging.Log;
import org.druid.support.logging.LogFactory;
...
public class SQLUtils {
    ...
    private final static Log LOG = LogFactory.getLog(org.druid.sql.SQLUtils.class);
    ...
    public static String refactor(String sql, String dbType, Map<String, String> tableMapping) {
        List<SQLStatement> stmtList = parseStatements(sql, dbType);
        return org.druid.sql.SQLUtils.toSQLString(stmtList, dbType, null, null, tableMapping);
    }
