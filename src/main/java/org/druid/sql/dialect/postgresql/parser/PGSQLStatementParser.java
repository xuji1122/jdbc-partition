...
public class PGSQLStatementParser extends SQLStatementParser {
    ...
    public PGSQLStatementParser(org.druid.sql.dialect.postgresql.parser.PGExprParser parser) {
        super(parser);
    }

    public PGSQLStatementParser(String sql){
        super(new org.druid.sql.dialect.postgresql.parser.PGExprParser(sql));
    }
