 ...
 */
package org.druid.sql.dialect.sqlserver.parser;
...
public class SQLServerSelectParser extends SQLSelectParser {
    ...
    public SQLServerSelectParser(String sql){
        super(new org.druid.sql.dialect.sqlserver.parser.SQLServerExprParser(sql));
    }
    ...
    protected org.druid.sql.dialect.sqlserver.parser.SQLServerExprParser createExprParser() {
