 ...
 */
package org.druid.sql.dialect.sqlserver.ast.expr;
...
import org.druid.sql.dialect.sqlserver.ast.SQLServerObjectImpl;
import org.druid.sql.dialect.sqlserver.ast.expr.SQLServerExpr;
...
public class SQLServerObjectReferenceExpr extends SQLServerObjectImpl implements SQLServerExpr, SQLName {
    ...
    public org.druid.sql.dialect.sqlserver.ast.expr.SQLServerObjectReferenceExpr clone() {
        org.druid.sql.dialect.sqlserver.ast.expr.SQLServerObjectReferenceExpr x = new org.druid.sql.dialect.sqlserver.ast.expr.SQLServerObjectReferenceExpr();
        x.server = server;
        x.database = database;
        x.schema = schema;
        return x;
