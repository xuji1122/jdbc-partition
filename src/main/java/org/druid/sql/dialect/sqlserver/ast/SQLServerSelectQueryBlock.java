 ...
 */
package org.druid.sql.dialect.sqlserver.ast;
...
public class SQLServerSelectQueryBlock extends SQLSelectQueryBlock {
    ...
    private org.druid.sql.dialect.sqlserver.ast.SQLServerTop top;

    public org.druid.sql.dialect.sqlserver.ast.SQLServerTop getTop() {
        return top;
    }
