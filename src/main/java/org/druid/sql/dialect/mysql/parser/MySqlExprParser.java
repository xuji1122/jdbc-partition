...
import org.druid.sql.dialect.mysql.ast.MysqlForeignKey.Match;
import org.druid.sql.dialect.mysql.ast.MysqlForeignKey.Option;
...
import org.druid.sql.dialect.mysql.ast.expr.MySqlIntervalUnit;
import org.druid.sql.dialect.mysql.ast.expr.MySqlMatchAgainstExpr;
import org.druid.sql.dialect.mysql.ast.expr.MySqlMatchAgainstExpr.SearchModifier;
...
import org.druid.sql.dialect.mysql.parser.MySqlSelectParser;
...
public class MySqlExprParser extends SQLExprParser {
    ...
    public MySqlExprParser(String sql){
        this(new org.druid.sql.dialect.mysql.parser.MySqlLexer(sql));
