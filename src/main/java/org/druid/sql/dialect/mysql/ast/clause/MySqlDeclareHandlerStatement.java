...
public class MySqlDeclareHandlerStatement extends MySqlStatementImpl {
	...
	private List<org.druid.sql.dialect.mysql.ast.clause.ConditionValue> conditionValues;


	public MySqlDeclareHandlerStatement() {
		conditionValues = new ArrayList<org.druid.sql.dialect.mysql.ast.clause.ConditionValue>();
	}

	public List<org.druid.sql.dialect.mysql.ast.clause.ConditionValue> getConditionValues() {
