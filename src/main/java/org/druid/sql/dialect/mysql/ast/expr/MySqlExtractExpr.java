 ...
 */
package org.druid.sql.dialect.mysql.ast.expr;

import org.druid.sql.ast.SQLExpr;
import org.druid.sql.ast.SQLExprImpl;
import org.druid.sql.dialect.mysql.ast.expr.MySqlExpr;
...
public class MySqlExtractExpr extends SQLExprImpl implements MySqlExpr {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof org.druid.sql.dialect.mysql.ast.expr.MySqlExtractExpr)) {
            return false;
        }
        org.druid.sql.dialect.mysql.ast.expr.MySqlExtractExpr other = (org.druid.sql.dialect.mysql.ast.expr.MySqlExtractExpr) obj;
        if (unit != other.unit) {
            return false;
        }
        if (value == null) {
