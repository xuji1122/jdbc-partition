 ...
 */
package org.druid.sql.dialect.db2.parser;
...
import org.druid.sql.dialect.db2.ast.stmt.DB2SelectQueryBlock.Isolation;
...
public class DB2SelectParser extends SQLSelectParser {
    ...
    public DB2SelectParser(String sql){
        this(new org.druid.sql.dialect.db2.parser.DB2ExprParser(sql));
    }
