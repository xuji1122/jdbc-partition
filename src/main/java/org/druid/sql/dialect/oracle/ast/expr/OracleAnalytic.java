...
public class OracleAnalytic extends SQLOver implements OracleExpr {
    ...
    public org.druid.sql.dialect.oracle.ast.expr.OracleAnalytic clone() {
        org.druid.sql.dialect.oracle.ast.expr.OracleAnalytic x = new org.druid.sql.dialect.oracle.ast.expr.OracleAnalytic();
