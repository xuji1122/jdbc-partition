...
import org.druid.sql.ast.SQLSetQuantifier;
...
import org.druid.sql.ast.statement.SQLJoinTableSource.JoinType;
...
import org.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import org.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import org.druid.sql.dialect.oracle.ast.OracleDataTypeTimestamp;
import org.druid.sql.dialect.oracle.ast.clause.CycleClause;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import org.druid.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
import org.druid.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import org.druid.sql.dialect.oracle.ast.clause.OracleReturningClause;
import org.druid.sql.dialect.oracle.ast.clause.OracleStorageClause;
import org.druid.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import org.druid.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import org.druid.sql.dialect.oracle.ast.clause.SampleClause;
import org.druid.sql.dialect.oracle.ast.clause.SearchClause;
import org.druid.sql.dialect.oracle.ast.expr.OracleAnalytic;
import org.druid.sql.dialect.oracle.ast.expr.OracleAnalyticWindowing;
import org.druid.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleBinaryDoubleExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleBinaryFloatExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleCursorExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleDatetimeExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleDbLinkExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleIntervalExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleIsSetExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleOuterExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleRangeExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleSizeExpr;
import org.druid.sql.dialect.oracle.ast.expr.OracleSysdateExpr;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterProcedureStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterSessionStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterSynonymStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableDropPartition;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableModify;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableMoveTablespace;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableTruncatePartition;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceAddDataFile;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterTriggerStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleAlterViewStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleCheck;
import org.druid.sql.dialect.oracle.ast.stmt.OracleConstraint;
import org.druid.sql.dialect.oracle.ast.stmt.OracleContinueStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleCreateDatabaseDbLinkStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleCreateIndexStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleCreatePackageStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleDeleteStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleDropDbLinkStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleExecuteImmediateStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleExitStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleExplainStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleExprStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleFileSpecification;
import org.druid.sql.dialect.oracle.ast.stmt.OracleForStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleForeignKey;
import org.druid.sql.dialect.oracle.ast.stmt.OracleGotoStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleInsertStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleLabelStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleLockTableStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import org.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import org.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import org.druid.sql.dialect.oracle.ast.stmt.OraclePLSQLCommitStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OraclePrimaryKey;
import org.druid.sql.dialect.oracle.ast.stmt.OracleRaiseStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectJoin;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivot;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectQueryBlock;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectSubqueryTableSource;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectTableReference;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSelectUnPivot;
import org.druid.sql.dialect.oracle.ast.stmt.OracleSetTransactionStatement;
...
import org.druid.sql.dialect.oracle.ast.stmt.OracleUnique;
import org.druid.sql.dialect.oracle.ast.stmt.OracleUpdateStatement;
import org.druid.sql.dialect.oracle.ast.stmt.OracleUsingIndexClause;
...
//    }
    ...
    @Override
    public void endVisit(org.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {

    }

    @Override
    public boolean visit(org.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
        print0(ucase ? "WHEN " : "when ");
        x.getWhen().accept(this);
        print0(ucase ? " THEN" : " then");
