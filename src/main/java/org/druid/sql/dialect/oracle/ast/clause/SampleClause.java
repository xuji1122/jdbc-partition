...
public class SampleClause extends OracleSQLObjectImpl {
    ...
    public org.druid.sql.dialect.oracle.ast.clause.SampleClause clone() {
        org.druid.sql.dialect.oracle.ast.clause.SampleClause x = new org.druid.sql.dialect.oracle.ast.clause.SampleClause();
