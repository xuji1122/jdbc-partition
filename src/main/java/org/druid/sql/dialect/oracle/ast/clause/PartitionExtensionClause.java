...
public class PartitionExtensionClause extends OracleSQLObjectImpl {
    ...
    public org.druid.sql.dialect.oracle.ast.clause.PartitionExtensionClause clone() {
        org.druid.sql.dialect.oracle.ast.clause.PartitionExtensionClause x = new org.druid.sql.dialect.oracle.ast.clause.PartitionExtensionClause();
