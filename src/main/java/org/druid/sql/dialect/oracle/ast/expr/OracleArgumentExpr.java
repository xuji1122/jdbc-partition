...
public class OracleArgumentExpr extends OracleSQLObjectImpl implements SQLExpr {
    ...
    public org.druid.sql.dialect.oracle.ast.expr.OracleArgumentExpr clone() {
        org.druid.sql.dialect.oracle.ast.expr.OracleArgumentExpr x = new org.druid.sql.dialect.oracle.ast.expr.OracleArgumentExpr();
