...
public class OracleSysdateExpr extends OracleSQLObjectImpl implements SQLExpr {
    ...
    public org.druid.sql.dialect.oracle.ast.expr.OracleSysdateExpr clone() {
        org.druid.sql.dialect.oracle.ast.expr.OracleSysdateExpr x = new org.druid.sql.dialect.oracle.ast.expr.OracleSysdateExpr();
        x.option = option;
        return x;
    }
}
