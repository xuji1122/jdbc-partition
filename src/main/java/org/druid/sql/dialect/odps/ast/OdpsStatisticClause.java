...
import org.druid.sql.dialect.odps.ast.OdpsObjectImpl;
import org.druid.sql.dialect.odps.visitor.OdpsASTVisitor;

public abstract class OdpsStatisticClause extends OdpsObjectImpl {

    public static abstract class ColumnStatisticClause extends org.druid.sql.dialect.odps.ast.OdpsStatisticClause {
    ...
    public static class ExpressionCondition extends org.druid.sql.dialect.odps.ast.OdpsStatisticClause {
    ...
    public static class TableCount extends org.druid.sql.dialect.odps.ast.OdpsStatisticClause {
